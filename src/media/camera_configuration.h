...
public:
  ...
  void AddConfiguration(const std::string &config_name, const std::string &value);
...
//
inline void
CameraConfiguration::AddConfiguration(const std::string &config_name, const std::string &value)
{
  configuration_.insert(std::pair<std::string, std::string>(config_name, value));
}
...
//
inline void
CameraConfiguration::SetGUID(uint64_t guid)
{
  guid_ = guid;
}
...
//
inline uint64_t
CameraConfiguration::GetGUID() const
{
  return guid_;
}
...
//
void
CameraConfiguration::SetName(const std::string &name)
{
  name_ = name;
}
...
//
std::string
CameraConfiguration::GetName() const
{
  return name_;
}
...
//
inline void
CameraConfiguration::SetUndistortionMatricePath(const std::string path)
{
...
//
inline std::string
CameraConfiguration::GetUndistortionMatricePath() const
{
