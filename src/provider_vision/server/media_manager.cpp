...
//
    MediaStreamer::Ptr
    MediaManager::StartMedia(const std::string &media_name)
    {
...
//
    BaseMedia::Ptr
    MediaManager::GetMedia(const std::string &name) const noexcept {
...
//
    ...
    MediaManager::GetAllMediasName() const noexcept
    {
...
//
    void
    MediaManager::SetCameraFeature(const std::string &media_name,
...
//
    float
    MediaManager::GetCameraFeature(const std::string &media_name,
