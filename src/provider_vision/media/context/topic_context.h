...
#ifndef PROVIDER_VISION_MEDIA_CONTEXT_TOPIC_H_
#define PROVIDER_VISION_MEDIA_CONTEXT_TOPIC_H_
 ...
 * _live_camera_list.
 */
    class TopicContext : public BaseContext {
    public:
        ...
        using Ptr = std::shared_ptr<TopicContext>;
