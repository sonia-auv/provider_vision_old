...
#ifndef PROVIDER_VISION_MEDIA_IMAGE_TOPIC_H_
#define PROVIDER_VISION_MEDIA_IMAGE_TOPIC_H_
 ...
 */
    class ImageTopic : public BaseMedia {
    public:
        //==========================================================================
        // T Y P E D E F   A N D   E N U M

        using Ptr = std::shared_ptr<ImageTopic>;

        //==========================================================================
        // P U B L I C   C / D T O R S

        explicit ImageTopic(const std::string &topic_name) noexcept;
...
#endif  // #define PROVIDER_VISION_MEDIA_IMAGE_TOPIC_H_
